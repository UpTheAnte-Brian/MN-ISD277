...
map.getView().fit([-10441348.648790, 5603925.945780, -10411429.886254, 5620887.267428], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">UpTheAnte.org</h2>';
        return titleElement;
    })(),
